  ...
  return (
    <div className={style.header}>
      ...
      <div className={style.headerNav}>
        <Link href="/shop" className={style.headerNavItem}>Shop</Link>
        <Link href="/contact" className={style.headerNavItem}>Contact</Link>
        <Link href="/cart" className={`${style.headerNavItem} ${ products.length ? style.headerNavItemActive : ''}`}>
          <Cart />
          { !!products.length && (
            <span className={style.headerNavItemIndicator}>
              { products.length }
            </span>
          ) }
        </Link>
